...
<!--heading-II-filter-->  
<?php include"blocks/filter-header-old/filter-header-old.php"; ?>
<!--/heading-II-filter-->

<!--sorting-->
<?php include"blocks/sorting/sorting.php"; ?>
<!--/sorting-->
...
<!--catalog block - main block-->
    <div class="cat-block-main__row cs-max-width">        
        ...
        <div class="cat-block-top__item-big">
            <div class="cat-big-block-align">
                <div class="cat-big-block media"> 
                    <img src="<?php echo get_template_directory_uri(); ?>/images/catalog/cat-block-top__item-img-action-big.png" alt="" class="cat-big-block__img d-flex mr-5">
        ...
        800х2000х35; 900х2000х35</p>
                        <div class="cat-big-block__button" data-toggle="modal" data-target="#kupit">оставить заявку</div>
                    </div>
                </div>
            </div>
        </div>
