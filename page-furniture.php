...
<!-- Top Slider -->
<?php
include"blocks/catalog-top-slider__furniture/catalog-top-slider__furniture.php"
?>
<!--/ Top Slider -->
    ...
    <!-- Title and tabs -->
        ...
        <div class="mebel-korpus__furniture-top-row">
            ...
            <div class="furniture-title-row">
                <div class="mebel-korpus__furniture-top-title">Фурнитура</div>
                <div onclick="roto()" id="roto" class="cat-door-type cat-door-type__interior mod_margin-0-15 active">
                    Roto<img class="cat-door-type__img" src="http://psp-wp.nolimit.by/wp-content/themes/psp/images/meb-okna/roto.png" alt="">
                </div>
                <div onclick="maco()" id="maco" class="cat-door-type cat-door-type__furniture mod_margin-0-15">
                    Maco<img class="cat-door-type__img" src="http://psp-wp.nolimit.by/wp-content/themes/psp/images/meb-okna/maco.png" alt="">
                </div>

                <script>
                    function roto() {
                        document.getElementById("roto").classList.toggle("active");
                    }
                    function maco() {
                        document.getElementById("maco").classList.toggle("active");
                    }
                </script>
            </div>
...
<!-- Почему вам стоит купить фурнитуру именно у нас? -->
...
<!--/ Гарантия -->
    ...
    <?php //Purchase process
    include"blocks/purchase-process/purchase-process.php";
    ?>

<div style="background-color: #fff; width: 100%; position: relative;">
    <?php //Честные отзывы наших клиентов
    include"blocks/catalog-otzivi/catalog-otzivi.php";
    ?>

    <div class="okna-full__chestn-otzivi cs-max-width" style="margin: auto;">
