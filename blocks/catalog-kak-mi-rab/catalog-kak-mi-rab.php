    ...
    <!-- Items -->
        ...
        <div class="mebel-korpus__preimusch-item">
            <div id="mebel-korpus__process-item-1" class="mebel-korpus__preimusch-item-content">
                ...
                <div class="mebel-korpus__preimusch-item-label mebel-korpus__preimusch-item-label-kak">
                    <img src="<?php echo get_template_directory_uri(); ?>/images/meb-korp/mebel-korpus__process-1.png" alt="" class="">
                </div>
                <!--/Иконка с изображением-->
        ...
        <div class="mebel-korpus__preimusch-item">
            <div id="mebel-korpus__process-item-2" class="mebel-korpus__preimusch-item-content">
                ...
                <img src="<?php echo get_template_directory_uri(); ?>/images/meb-korp/mebel-korpus__process-arrow-down.png" alt="" class="mebel-korpus__preimusch-item-arrow-bottom">
                <div class="mebel-korpus__preimusch-item-label mebel-korpus__preimusch-item-label-kak">
                    <img src="<?php echo get_template_directory_uri(); ?>/images/meb-korp/mebel-korpus__process-2.png" alt="" class="mebel-korpus__preimusch-item-img mebel-korpus__preimusch-item-img-kak">
                </div>
                <div class="mebel-korpus__preimusch-item-info">
                    <div class="mebel-korpus__preimusch-item-title">
                        замер
        ...
        <div class="mebel-korpus__preimusch-item">
            <div id="mebel-korpus__process-item-3" class="mebel-korpus__preimusch-item-content">
                ...
                <img src="<?php echo get_template_directory_uri(); ?>/images/meb-korp/mebel-korpus__process-arrow-down.png" alt="" class="mebel-korpus__preimusch-item-arrow-bottom">
                <div class="mebel-korpus__preimusch-item-label mebel-korpus__preimusch-item-label-kak">
                    <img src="<?php echo get_template_directory_uri(); ?>/images/meb-korp/mebel-korpus__process-3.png" alt="" class="mebel-korpus__preimusch-item-img mebel-korpus__preimusch-item-img-kak">
                </div>
                <div class="mebel-korpus__preimusch-item-info">
                    <div class="mebel-korpus__preimusch-item-title">
                        документы
        ...
        <div class="mebel-korpus__preimusch-item">
            <div id="mebel-korpus__process-item-4" class="mebel-korpus__preimusch-item-content">
                ...
                <img src="<?php echo get_template_directory_uri(); ?>/images/meb-korp/mebel-korpus__process-arrow-down.png" alt="" class="mebel-korpus__preimusch-item-arrow-bottom">
                <div class="mebel-korpus__preimusch-item-label mebel-korpus__preimusch-item-label-kak">
                    <img src="<?php echo get_template_directory_uri(); ?>/images/meb-korp/mebel-korpus__process-4.png" alt="" class="mebel-korpus__preimusch-item-img mebel-korpus__preimusch-item-img-kak">
                </div>
                <div class="mebel-korpus__preimusch-item-info">
                    <div class="mebel-korpus__preimusch-item-title">
                        производство
        ...
        <div class="mebel-korpus__preimusch-item">
            <div id="mebel-korpus__process-item-5" class="mebel-korpus__preimusch-item-content">
                ...
                <img src="<?php echo get_template_directory_uri(); ?>/images/meb-korp/mebel-korpus__process-arrow-down.png" alt="" class="mebel-korpus__preimusch-item-arrow-bottom">
                <div class="mebel-korpus__preimusch-item-label mebel-korpus__preimusch-item-label-kak">
                    <img src="<?php echo get_template_directory_uri(); ?>/images/meb-korp/mebel-korpus__process-5.png" alt="" class="mebel-korpus__preimusch-item-img mebel-korpus__preimusch-item-img-kak">
                </div>
                <div class="mebel-korpus__preimusch-item-info">
                    <div class="mebel-korpus__preimusch-item-title">
                        установка
        ...
        <div class="mebel-korpus__preimusch-item">
            <div id="mebel-korpus__process-item-6" class="mebel-korpus__preimusch-item-content">
                ...
                <img src="<?php echo get_template_directory_uri(); ?>/images/meb-korp/mebel-korpus__process-arrow-down.png" alt="" class="mebel-korpus__preimusch-item-arrow-bottom">
                <div class="mebel-korpus__preimusch-item-label mebel-korpus__preimusch-item-label-kak">
                    <img src="<?php echo get_template_directory_uri(); ?>/images/meb-korp/mebel-korpus__process-6.png" alt="" class="mebel-korpus__preimusch-item-img mebel-korpus__preimusch-item-img-kak">
                </div>
                <div class="mebel-korpus__preimusch-item-info">
                    <div class="mebel-korpus__preimusch-item-title">
                        обратная связь
