<?php
/*
 Template Name: Двери ПВХ - нестандартные
*/
?>
...
<div class="breadcrumb_bg container-fluid no-padding">
    <div class="container">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Двери ПВХ (нестандартные)</li>
        </ol>
    </div>
</div>
<!--/breadcrumbs-->
...
<!--catalog block - title-->
<div class="catalog-block-title dveri-pvh-nestandart container">
    <div class="catalog-block-title-text">
...
<!-- Items -->
    <div class="mebel-korpus__preimusch-item">
        <div class="mebel-korpus__preimusch-item-content">
            <div class="mebel-korpus__preimusch-item-label">
                <img src="<?php echo get_template_directory_uri(); ?>/images/dveri-pvh-nestandart/nestandart-preim1.png" alt="" class="mebel-korpus__preimusch-item-img">
            </div>
    ...
    <div class="mebel-korpus__preimusch-item">
        <div class="mebel-korpus__preimusch-item-content">
            <div class="mebel-korpus__preimusch-item-label">
                <img src="<?php echo get_template_directory_uri(); ?>/images/dveri-pvh-nestandart/nestandart-preim2.png" alt="" class="mebel-korpus__preimusch-item-img">
            </div>
            <div class="mebel-korpus__preimusch-item-info">
                <div class="mebel-korpus__preimusch-item-title">
                    Универсальность
    ...
    <div class="mebel-korpus__preimusch-item">
        <div class="mebel-korpus__preimusch-item-content">
            <div class="mebel-korpus__preimusch-item-label">
                <img src="<?php echo get_template_directory_uri(); ?>/images/dveri-pvh-nestandart/nestandart-preim3.png" alt="" class="mebel-korpus__preimusch-item-img">
            </div>
            <div class="mebel-korpus__preimusch-item-info">
                <div class="mebel-korpus__preimusch-item-title">
                    Современность
...
<br><br>
Алюминиевые входные двери для магазина или офиса вполне привычны – перед входом в компанию мы привыкли открывать именно их. Владельцы собственного бизнеса останавливаются на варианте дверей из алюминиевого профиля потому, что они обладают большим запасом механической прочности и долговечности. Поэтому данные конструкции активно применяются в местах с очень интенсивным движением посетителей. Нередки случаи, когда владельцы и коттеджей принимают решение купить входную алюминиевую дверь для загородного дома. Причины их выбора понятны: конструкции не требуют особенного ухода, прочны и способны прослужить на протяжении долгого времени.
        </div>
        <div class="nestandart-where-img-block">
            <div class="nestandart-where-img">
                <img src="<?php echo get_template_directory_uri(); ?>/images/dveri-pvh-nestandart/nestandart-where1.png" alt="" class="nestandart-where-image">
                <div class="nestandart-where-img-title">Офис</div>
            </div>
            <div class="nestandart-where-img">
                <img src="<?php echo get_template_directory_uri(); ?>/images/dveri-pvh-nestandart/nestandart-where2.png" alt="" class="nestandart-where-image">
                <div class="nestandart-where-img-title">Предприятие</div>
            </div>
            <div class="nestandart-where-img">
...
-->
            ...
            <p><strong>Двустворчатые двери со штульпом</strong> устанавливаются в больших проёмах. Как правило, одна из створок такой двери является рабочей и открывается/закрывается при помощи ручки. Вторая створка, использующаяся реже, держится на шпингалетах.</p>
            <p><strong>Двустворчатые двери.</strong> Такой тип распашных дверей устанавливается в широких проёмах. Для удобства входа и выхода обе створки дверей функционируют.</p>
            <p style="color: #1377bd; font-size: 18px; font-weight: bold;">Покраска входных дверей</p>
    ...
    <div class="nestandart-where-img-block">
        <div class="nestandart-where-img">
            <img src="<?php echo get_template_directory_uri(); ?>/images/dveri-pvh-nestandart/nestandart-where1.png" alt="" class="nestandart-where-image">
            <div class="nestandart-where-img-title">Тонированный</div>
            <div class="nestandart-where-img-descripton">
                Данный стеклопакет производится при помощи тонированной плёнки или тонировки стекла в массе. Обеспечивает дополнительную конфиденциальность.
            </div>
        </div>
        <div class="nestandart-where-img">
            <img src="<?php echo get_template_directory_uri(); ?>/images/dveri-pvh-nestandart/nestandart-where2.png" alt="" class="nestandart-where-image">
            <div class="nestandart-where-img-title">Матовый</div>
            <div class="nestandart-where-img-descripton">
                Этот вид стеклопакетов обладает возможностью задерживать солнечный свет, а также имеют привлекательный внешний вид.
            </div>
        </div>
        <div class="nestandart-where-img">
            <img src="<?php echo get_template_directory_uri(); ?>/images/dveri-pvh-nestandart/nestandart-where3.png" alt="" class="nestandart-where-image">
            <div class="nestandart-where-img-title">Зеркальный</div>
            <div class="nestandart-where-img-descripton">
...
<div class="text-block container dveri-pvh-nestandart">
    <div class="text-block__preview">
        <div class="text-block__title">
        ...
        <div class="text-block__text-body">
            ...
            <ul class="dveri-pvh__popular-models">
                <li>дополнительные наборы дверных ручек;</li>
                <li>установку отливов (во избежание попадания воды внутрь помещения);</li>
                <li>монтаж фрамуги (для обеспечения циркуляции воздуха);</li>
                <li>установку или замену алюминиевых окон.</li>
            </ul>
        </div>
    </div>
    ...
    <div class="text-block__preview">
        ...
        <div class="text-block__text-body">
            <div class="nestandart-where-img nestandart-rolstavni-image">
                ...
                <div class="nestandart-where-img-title">Рольставни</div>
            </div>
                <span style="color: #1377bd; font-size: 18px; font-weight: bold;">Выбор двери по количеству створок</span><br>
Компания «Профспецпласт» занимается установкой рольставней на входные группы дверей. Данная конструкция обеспечивает немало преимуществ.
                <ul class="dveri-pvh__popular-models dveri-pvh-nestandart">
                    <li>Дополнительная теплоизоляция.</li>
                    <li>Усиленная защита от преступных посягательств.</li>
                    <li>Защита помещения от пагубного воздействия непогоды (дождя, снега, перепада температур).</li>
                    <li>Надёжность и прочность.</li>
    ...
    <div class="text-block__preview">
        ...
        <div class="text-block__text-body">
            ...
            <div class="cat-filter-btn dveri-pvh__zakazat-zamer nestandart-uznat-stoimost" data-toggle="modal" data-target="#obratny-zvonok" data-whatever="@mdo">
                <img class="dveri-pvh__zakazat-zamer-img" src="<?php echo get_template_directory_uri(); ?>/images/dveri-pvh-nestandart/nestandart-uznat-stoimost.png" alt="">
                <span class="dveri-pvh__zakazat-zamer-text">Узнать стоимость</span>
            </div>
        </div>
    </div>
</div>
