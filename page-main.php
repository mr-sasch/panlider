            ...
            <div class="main-section__cont-inner">
                ...
                <div class="main-section__cont-text">
                    <div class="main-section__text">
                        <a href="#"><p>ОКНА ПВХ</p></a>
                        <a href="#"><p>БАЛКОННЫЕ РАМЫ</p></a>
                    </div>
                </div>
            </div>
    <!--/text block-->
...
<!--main-section item-->   
    ...
    <!--text block-->
            <div class="main-section__cont-inner">
                ...
                <div class="main-section__cont-text">
                    <div class="main-section__text">
                        <a href="#"><p>ДВЕРИ ВХОДНЫЕ</p></a>
                        <a href="#"><p>ДВЕРИ МЕЖКОМНАТНЫЕ</p></a>
                    </div>
                </div>
            </div>
    <!--/text block-->
...
<!--about us-->
    ...
    <!--/left block-->
            <div class="about-us-left col-12 col-lg-6">
                ...
                <a class="about-us-left__button-a" href="/psp-wp/о-компании/">
    ...
    <!-- Что говорят о нас клиенты -->
            ...
            <a href="/psp-wp/отзывы/" class="about-us-right__all">Все отзывы</a>  
            </div>    
    <!--/ Что говорят о нас клиенты -->
...
<!--any questions-->
        ...
        <div class="questions__button" data-toggle="modal" data-target="#poluchit-consult" data-whatever="@mdo">
