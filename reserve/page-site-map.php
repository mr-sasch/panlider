...
<!-- Содержимое страницы -->
<div id="site-map" class="about-company-text cs-max-width">
   
<ul class='site-map__first-level'>
    <li><a href="#">Компания</a>
        <ul class="site-map__second-level">
            <a href="#"><li>О компании</li></a>
            <a href="#"><li>Сотрудники</li></a>
    ...
    <li><a href="#">Покупателям</a>
        <ul class="site-map__second-level">
            ...
            <a href="#"><li>Кредит и рассрочка</li></a>
            <a href="#"><li>Как купить</li></a>
