...
<!--column 1-->
                <div class="footer-logo col-8 offset-3 col-sm-6 offset-sm-0 col-lg-3">
                    <div class="footer-logo-title">
                        <img src="http://localhost/psp-wp/wp-content/themes/psp/images/footer-logo-title.png" alt="" class="header-bottom-menu__logo">
                    </div>
                        ...
                        <div class="row no-gutters">
                            <div class="copywrite__developer col-6">
                                <div class="copywrite__developer_align">
                                    ...
                                    <div class="copywrite__developer-logo">
                                        <img src="http://localhost/psp-wp/wp-content/themes/psp/images/copywrite__developer-logo-no-limit.png" alt="">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="copywrite__developer col-6">
                                <div class="copywrite__developer_align">
                                    ...
                                    <div class="copywrite__developer-logo">
                                        <img src="http://localhost/psp-wp/wp-content/themes/psp/images/copywrite__developer-logo-scroll.png" alt="">
                                    </div>
                                </div>
                            </div>
...
<!-- Video gallery Scripts -->   
    <!--Videogallery links-->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/lightgallery/1.2.19/js/lightgallery-all.min.js" async></script>
    ...
    <script src="http://localhost/psp-wp/wp-content/themes/psp/js/gallery-video-lightbox.js"></script>
    <!--  video gallery - view more -->
    <script src="http://localhost/psp-wp/wp-content/themes/psp/js/gallery-video_more-video.js"></script>
<!--/ Video gallery Scripts --> 

<!-- fixed top menu -->
<script src="http://localhost/psp-wp/wp-content/themes/psp/js/fixed-top-header.js"></script>
<!--/ fixed top menu -->

<!-- show and hide metering -->
<script src="http://localhost/psp-wp/wp-content/themes/psp/js/show-and-hide-metering.js"></script>
<!--/ show and hide metering -->

<!-- scroll to top -->
<script src="http://localhost/psp-wp/wp-content/themes/psp/js/scroll-to-top.js"></script>
<!--/ scroll to top -->

<!-- photo gallery -->
<script src="http://localhost/psp-wp/wp-content/themes/psp/baguetteBox-photoGallery/baguetteBox.js"></script>
<!--/ photo gallery -->
