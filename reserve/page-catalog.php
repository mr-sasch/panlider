...
<div class="cat-block">
    ...
    <!--catalog block - top row-->
    <div class="cat-block-top cs-max-width">
            ...
            <div class="cat-block-top__item-align">
                <div class="cat-block-top__item">
                    <div class="cat-block-top__item-align-center">
                        ...
                        <div class="cat-block-top__item-buy" data-target="#kupit" data-toggle="modal">
                            купить
                        </div>
                    </div>    
                </div>               
        ...
        <div class="cat-block-top__item">           
            <div class="cat-block-top__item-align mod_margin-top-70">
                <div class="cat-block-top__item">
                    <div class="cat-block-top__item-align-center">
        ...
        <div class="cat-block-top__item-big">
            <div class="cat-big-block-align">
                <div class="cat-big-block media"> 
                    <img src="<?php echo get_template_directory_uri(); ?>/images/catalog/cat-block-top__item-img-action-big.png" alt="" class="d-flex mr-5">
        ...
        800х2000х35; 900х2000х35</p>
                        <div class="cat-big-block__button">оставить заявку</div>
                    </div>
                </div>
            </div>
        </div>
