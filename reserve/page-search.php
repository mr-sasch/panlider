...
<!--Search text-->
<div id="search-page" class="about-company-text cs-max-width">
    
    <!--Search-->
    <div class="search-page__search-row">
        <form class="header-bottom-menu-search">
            <input type="text" name="search" placeholder="Двери">
        </form>
        <div class="cat-big-block__button">ИСКАТЬ</div>
    </div>
    <!--/Search-->
    
    <!--Quantity-->
    <div class="search-page__result-quantity">
        По запросу «Двери» найдено <span class="search-mod__result-quantity-number">2009</span> совпадений.
    </div>
    <!--/Quantity-->
    
    <!--Search result-->
    <div class="search-page__result-item">
        <div class="search-page__result-item-col-bullet">
            <div class="search-page__result-item-bullet"></div>
        </div>
        <div class="search-page__result-item-col-text">
            <a href="#" class="search-page__result-item-col-text-title">
                Двери межкомнатные Юркас
            </a>
            <div class="search-page__result-item-col-text-preview">
                ФК 3 мм 1525х1525 сорт 4/4 нешлифованная 07759 07759
            </div>
        </div>
    </div>
    ...
    <!--Pagination--> 
    <div class="search-page__pagination-cell">
        <div class="cat-sort-pagination">
