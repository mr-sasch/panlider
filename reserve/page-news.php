...
<!--Sort by date-->        
        <div class="news-sort-by-date">
            <div class="news-sort-by-date__arrow-up active">Сортировать по дате</div>
            <div class="news-sort-by-date__arrow-down">Сортировать по дате</div>
        </div>
<!--/Sort by date-->
        <div class="review__botton-block" data-toggle="modal" data-target="#subscribe-news" data-whatever="@mdo">
            <div class="review__botton">Подписаться на новости</div>
        </div>
        <div class="modal fade" id="subscribe-news" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">New message</h5>
...
<!--News items-->
    <!--News single item-->
<div class="news-item cs-max-width">
    <div class="media">
        <img class="media__img d-flex mr-3" src="<?php echo get_template_directory_uri(); ?>/images/news/news-item-img.png" alt="Generic placeholder image">
        <div class="media-body">
            ...
            <div class="news-item__content">
                Поздравляем семейную пару из Лиды с победой в «Новогодней викторине», которая проводилась 27 декабря среди зрителей на телеканале «Лида ТВ»! Фирменный подарочный сертификат на изготовление и установку ПВХ-окон торжественно вручил представитель компании «Окнаград» в прямом эфире!<br>
                Магазину требуются продавцы-консультанты с опытом работы со строительными материалами. 
            </div>
            <div class="news-item__read-new-btn">
                <a href="/psp-wp/новость/">Смотреть новость</a><i class="fa fa-long-arrow-right" aria-hidden="true"></i>
            </div>
        </div>
    </div>
</div> 
